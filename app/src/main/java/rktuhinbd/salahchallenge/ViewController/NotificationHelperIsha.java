...
//        context.startActivity(i);
    ...
    public NotificationCompat.Builder getChannelNotification() {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 5, mIntent, 0);
        ...
        PendingIntent pendingIntent_isha = PendingIntent.getActivity(getApplicationContext(), 5, repeating_intent, PendingIntent.FLAG_UPDATE_CURRENT);
        return new NotificationCompat.Builder(getApplicationContext(), channelID)
                .setContentIntent(pendingIntent_isha)
                .setContentTitle("Salah Reminder!")
                .setContentText("It's time to pray Isha")
